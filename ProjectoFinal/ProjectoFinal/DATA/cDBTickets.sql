...
/****** Object:  Database [TICKETS]    Script Date: 04/05/2017 16:09:21 ******/
CREATE DATABASE [TICKETS]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'TICKETS', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\TICKETS.mdf' , SIZE = 8192KB , MAXSIZE = UNLIMITED, FILEGROWTH = 65536KB )
 LOG ON 
( NAME = N'TICKETS_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL13.SQLEXPRESS\MSSQL\DATA\TICKETS_log.ldf' , SIZE = 8192KB , MAXSIZE = 2048GB , FILEGROWTH = 65536KB )
GO

ALTER DATABASE [TICKETS] SET COMPATIBILITY_LEVEL = 130
GO
